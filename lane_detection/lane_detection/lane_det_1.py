...
class DetectLane(Node):
    ...
    def __init__(self):
        ...
        self.saturation_white_h = 36
        self.lightness_white_l = 180
        self.lightness_white_h = 255

        self.hue_yellow_l = 27
        self.hue_yellow_h = 41
        self.saturation_yellow_l = 130
        self.saturation_yellow_h = 255
        self.lightness_yellow_l = 160
        self.lightness_yellow_h = 255

        self.is_calibration_mode = True

        # subscribes compressed image
        self.sub_image_original = self.create_subscription(CompressedImage, '/test_image', self.cbFindLane, 1)
    ...
    def cbFindLane(self, image_msg):
        ...
        ##image_bytes = image_msg.tobytes()

        # Convert the bytes-like object to an array.array object
        ##image_array = array.array('B', image_bytes)

        #converting compressed image to opencv image
        ##np_arr = np.fromstring(image_array.data, np.uint8)   #<---<----#########################################################################################################
